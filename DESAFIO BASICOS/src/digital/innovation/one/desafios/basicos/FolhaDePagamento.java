...
public class FolhaDePagamento {
    public static void main(String[] args) throws IOException {
        ...
        StringTokenizer leitura = new StringTokenizer(br.readLine());
        int valor1 = Integer.parseInt(leitura.nextToken());

        leitura = new StringTokenizer(br.readLine());
        int valor2 = Integer.parseInt(leitura.nextToken());

        leitura = new StringTokenizer(br.readLine());
        double valor3 = Double.parseDouble(leitura.nextToken());
